// Small inline SVG icons. Kept as plain components in one file rather than
// pulling in an icon library — it's a handful of paths and avoids another
// dependency. All of them inherit colour via `currentColor`.
type IconProps = { className?: string }

const base = 'h-5 w-5'

// Google's official "G" mark — fixed brand colors, doesn't inherit currentColor.
...
export function MapIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <path d="m10.3 10.6-3.7-3.2M13.7 10.6l3.7-3.2M10.3 13.4l-3.7 3.2M13.7 13.4l3.7 3.2" />
    </svg>
  )
}
