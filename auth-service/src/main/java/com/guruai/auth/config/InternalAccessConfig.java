 ...
 *
 * <p>Runs at {@code Ordered.HIGHEST_PRECEDENCE}, ahead of Spring Security's
 * own filter chain (registered further down by {@link SecurityConfig}), so
 * a request gets rejected here before it even reaches {@code JwtAuthFilter}.
 */
@Configuration
