package com.guruai.knowledge.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleGuruAI(GuruAIException ex) {
    ...
    public ResponseEntity<ApiResponse<Void>> handleGeneral(Exception ex) {
        log.error("Unhandled error in knowledge-service", ex);
